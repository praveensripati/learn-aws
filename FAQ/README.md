...
1. What are the IP addrss for after creation of the EFS
...
1. Does ELB works as forward or reverse proxy?
...
1. Can we change the rotation duration for AWS Managed Keys?
Depends on the type of key as mentioned in the below document.
...
Automatic key rotation has no effect on the data that the CMK protects. It does not rotate the data keys that the CMK generated or re-encrypt any data protected by the CMK, and it will not mitigate the effect of a compromised data key.
...
1000 - https://docs.amazonaws.cn/en_us/AmazonS3/latest/dev/list-obj-version-enabled-bucket.html

1. What is the cost of storage gatway ?
https://aws.amazon.com/storagegateway/pricing/

1. Getting started with storage gateay
...
In multi-master clusters, there are N read-write nodes. Currently, the maximum for N is 2.
...
How to Configure Your Amazon RDS Database Instance for High Availability https://www.youtube.com/watch?v=uiiS1h4PSI8
